...
<h1 className="text-4xl md:text-6xl font-bold leading-tight"> Build Your<span className="bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 bg-clip-text text-transparent"> Perfect Dev Stack</span></h1>
